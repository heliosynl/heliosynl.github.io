...
collection: codes
date: 2024-12-28
excerpt: 'Averaging and plotting electrostatic potential distribution in space, by self-defined averaging parameters, for work function calculation in Quantum Espresso'
codeurl: '/files/codes/PotDistribution.py'
permalink: /codes/potdistribution/
---
